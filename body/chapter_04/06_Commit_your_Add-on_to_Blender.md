...
Blenderのアドオンのコーディング規約は、Pythonのコーディング規約であるpep8に準拠しています。次に示すサイトを参考にして、作成したソースコードがpep8に従っているかを確認しながら、アドオンを作成しましょう。なお、1行の最大文字数が79文字を超えてはならないpep8-80と呼ばれるものありますが、あくまで推奨としているだけのようです。
