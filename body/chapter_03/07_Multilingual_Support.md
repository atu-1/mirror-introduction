...
###### BlenderのUIは英語がデフォルトであることから、海外でも多くの3DCGデザイナーがBlenderを使っています。このため、アドオンのUIも英語ベースで構築するほうが、アドオンを使ってくれる方が多くなります。<br>しかし一方で、日本語などの英語以外の言語をサポートすることにより、英語が苦手な方が困らないようにしたいと思う方もいると思います。そこで本節では、アドオンのUIを複数の言語に対応する方法を説明します。
