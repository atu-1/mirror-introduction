...
本節では、mp3やwavなどのオーディオファイルを再生するためのオーディオプレイヤーアドオンを紹介します。オーティオファイルの再生については、[3-6節](../chapter_03/06_Play_Audio_File.md) のサンプルで説明しました。本節のサンプルでは [3-3節](../chapter_03/06_Play_Audio_File.md) のサンプルに機能を追加し、最低限オーディオプレイヤーと呼べようなアドオンにしました。
